...
# Define la ruta absoluta para guardarlo en la carpeta 'dataset'
ruta_actual = os.path.dirname(os.path.abspath(__file__))
ruta_guardado = os.path.join(ruta_actual, 'iris.csv')

columnas = ["sepal.length", "sepal.width", "petal.length", "petal.width", "variety"]
filas = [
    ...
    [5.7, 3.0, 4.2, 1.2, "Versicolor"], [5.7, 2.9, 4.2, 1.3, "Versicolor"], [6.2, 2.2, 4.5, 1.5, "Versicolor"],
...
print(f"✅ Archivo 'iris.csv' generado en el directorio local: {ruta_guardado}")